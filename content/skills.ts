...
export const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    description: "Modern web frameworks, UI libraries, real-time protocols, and state-driven interfaces.",
    skills: [
      { name: "Next.js 15 (App Router)", level: "Intermediate", featured: true },
      { name: "React 19", level: "Intermediate", featured: true },
      { name: "Node.js & Express", level: "Intermediate", featured: true },
      { name: "Socket.IO (WebSockets)", level: "Intermediate", featured: true },
  ...
  },
  {
    ...
    description: "Relational data modeling, cloud BaaS, ORMs, and security architectures.",
    skills: [
      { name: "Supabase", level: "Intermediate", featured: true },
      { name: "PostgreSQL", level: "Intermediate", featured: true },
      { name: "Prisma ORM", level: "Intermediate", featured: true },
