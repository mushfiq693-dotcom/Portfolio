...
export default function Achievements() {
  return (
    <section id="achievements" className="py-24 bg-[#090d15] relative overflow-hidden">
          ...
          {achievementsData.map((item) => {
            ...
            return (
              <motion.div
                ...
                className="glass-card rounded-2xl p-6 relative flex flex-col justify-between hover:-translate-y-1 transition-all duration-300 border border-white/10 hover:border-emerald-500/30"
              >
                <div>
